...
from .views import (vistaTriaje, vistaCrearTriaje, vistaCita, vistaCrearCita, vistaConsulta, vistaCrearConsulta, cancelarCita, BuscarCitaDni, BuscarConsultaHistoria
                    ,BuscarConsultaDni,BuscarTriajeHistoria, BuscarCitaMedico, BuscarTriajeCita, BuscarHistorialClinico, atenderCita, triajeCita,BuscarCitaEspecialidad,BuscarCitaMedicoEstado)#, vistaCitaTemporal)# vistaHistoriaConsulta)
...
urlpatterns = [
    ...
    url(r'^citaspormedico/Triado/$', BuscarCitaMedicoEstado.as_view(), name="BuscarCitasMedico"),
