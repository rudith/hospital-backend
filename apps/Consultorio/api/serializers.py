...
class OrdenViewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Orden
        fields = ['id','numeroHistoria','dni','nombre','medico','orden','tipoExam','tipoExamId','fechaA','fechaCreacion','estadoOrden'] 
...
class CitaViewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cita
        #fields = "__all__"
        fields = ['id','numeroHistoria','numeroHistoriaId','especialidad','especialidadId','medico','numeroRecibo','fechaSeparacion','updated_at','fechaAtencion','estadoCita','exonerado','responsable','estReg','turno','condicion']
