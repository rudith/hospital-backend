# Generated by Django 2.2.4 on 2019-11-11 15:49

import apps.Laboratorio.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dni', models.CharField(max_length=8, validators=[apps.Laboratorio.validators.dni])),
                ('orden', models.CharField(blank=True, max_length=100, null=True)),
                ('fecha', models.DateField(validators=[apps.Laboratorio.validators.fecha])),
