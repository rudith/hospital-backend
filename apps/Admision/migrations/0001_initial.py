...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('numeroHistoria', models.IntegerField(validators=[apps.Admision.validators.numeroHistoria])),
                ('dni', models.CharField(max_length=8, unique=True, validators=[apps.Admision.validators.dni])),
