    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dni', models.CharField(blank=True, error_messages={'unique': 'Este DNI ya ha sido registrado.'}, max_length=8, null=True, unique=True, validators=[apps.Admision.validators.dni])),
                ...
                ('lugarNac', models.CharField(blank=True, max_length=10, null=True)),
